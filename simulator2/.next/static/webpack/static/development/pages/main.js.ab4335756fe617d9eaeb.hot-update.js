...
function () {
  ...
  _createClass(BasicPerceptronModel, [{
    ...
    value: function evaluate(x, y) {
      ...
      var distanceToLine = x - this.k * (y - lineY);
    ...
    value: function evaluateCost(x, y, category) {
      var lineY = this.getClassificationLineY(0);
      var distanceToLine = Math.pow(x - this.k * (y - lineY), 2);
      return distanceToLine; // return Math.abs(this.evaluate(x, y) - category);
    }
  }, {
    key: "predict",
...
//# sourceMappingURL=main.js.ab4335756fe617d9eaeb.hot-update.js.map