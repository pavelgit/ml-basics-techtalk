...
function (_React$Component) {
  ...
  _createClass(_default, [{
    ...
    value: function generateData() {
      var basicPerceptronModel = new _source_basic_perceptron_model__WEBPACK_IMPORTED_MODULE_2__["default"]();
      var points = [];
      ...
      for (var k = -10; k < 10; k++) {
        for (var b = 0; b < 10; b++) {
          points.push({
            x: k,
            y: b,
            z: basicPerceptronModel.evaluateLoss(x, y)
          });
        }
      }
...
//# sourceMappingURL=main.js.af74404aad41d2b14efb.hot-update.js.map